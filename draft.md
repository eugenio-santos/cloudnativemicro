...
![monolith_microservices](monolith_versus_microservices.png "Monolith vs microservices")

Reliability is another big topic, but reliability is more about using cloud-native tools and the way you use them. It's not because Netflix uses a microservice architecture that their application has close to zero downtime. It’s the strategies and methodologies they put in place that allow them to keep operating as usual when a whole AWS region becomes unstable. Check [here](https://netflixtechblog.com/chaos-engineering-upgraded-878d341f15fa) to know more about how they build their chaos engineering system based on [chaos monkey](https://netflix.github.io/chaosmonkey/).
